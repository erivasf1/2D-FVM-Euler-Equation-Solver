...
class EulerExplicit {
  ...
  void FWDEulerAdvance(array<double,3>* &field,array<double,3>* &resid,vector<double> &time_steps,vector<double> &xcoords,double &dx); //Computing the new solution at the next time step
