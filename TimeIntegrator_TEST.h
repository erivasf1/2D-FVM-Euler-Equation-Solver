...
class EulerExplicit {
  ...
  double Density_min = 1.0e-3;
  double Velocity_min = 1.0e-3;
  double Pressure_min = 1.0e-3;

  double Density_max = 1.0e4;
  double Velocity_max = 1.0e4;
  double Pressure_max = 1.0e4;
